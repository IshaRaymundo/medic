...
const MedicationChart = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8083/obtenerNombreMedicamentos')
      .then((respuesta) => {
  ...
  const handleSaveMedication = () => {
    ...
    const newMedication = {
      ...
      horaDeAgregado, // Hora de Agregado
    };
            ...
            <thead>
              <tr>
                ...
                {[
                  ...
                  'Comments',
                  'Siguiente Dosis',
                  'Hora de Agregado', // Nuevo encabezado
                ].map((header) => (
                        ...
                        .map((med, index) => (
                          <div key={index} style={styles.column}>
                            {field === 'comentarios' && med.nombre in descriptions
                              ...
                              ? `(${calculateNextDose(med.horaInicio, parseInt(med.frecuencia)).toLocaleTimeString()})`
                              : field === 'Hora de Agregado' // Mostrar la hora de agregado
                              ? med.horaDeAgregado
                              : med[field]}
                          </div>
                        ))}
